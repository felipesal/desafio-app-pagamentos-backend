...
public class SellerInsertValidator implements ConstraintValidator<SellerInsert, SellerNewDTO> {
	...
	@Override
	public boolean isValid(SellerNewDTO obj, ConstraintValidatorContext context) {
